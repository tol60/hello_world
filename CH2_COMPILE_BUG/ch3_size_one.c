...
int main ()
{
  ...
  cout << "string st_en_short  = " << st_en_short << ", sizeof() = " << sizeof (st_en_short)  << endl;
  string st_en = "abc";
  cout << "string st_en  = " << st_en << ", sizeof() = " << sizeof (st_en)  << endl;
  string st_ru = "жюц";
  cout << "string st_ru  = " << st_ru << ", sizeof() = " << sizeof (st_ru)  << endl;
  string st_en_long= "1234567890123456789012345678901234567890";
  cout << "string st_en_long  = " << st_en_long << ", sizeof() = " << sizeof (st_en_long) << endl;
